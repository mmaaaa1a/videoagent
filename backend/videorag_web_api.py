...
def create_web_app():
    ...
    # Register web-specific routes first (including catch-all static file handler)
    register_web_routes(app)

    # Register all existing routes from videorag_api.py (API routes last to override catch-all)
...
if __name__ == '__main__':
    ...
    # Port configuration - direct use of SERVER_PORT
    SERVER_PORT = int(os.getenv('SERVER_PORT', 64451))
...
# Create global app instance for import compatibility
app = create_web_app()
